...
const getPendingOrders = asyncHandler(async (req, res) => {
    const pendingOrders = await Order.find({ status: "pending", "payment.status": "completed" });
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, "Pending orders retrieved successfully", pendingOrders));
});
...
const getRevenueChartData = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, "Revenue chart data retrieved successfully", chartData));
});
...
const getMonthlyRevenueData = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, "Monthly revenue data retrieved successfully", chartData));
});
...
const getOrderStatusData = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, "Order status data retrieved successfully", statusData));
});



export { initiateEsewaPayment, verifyPayment, getCompletedOrders, getOrderDetails, updateOrderStatus, getRevenueData, getPendingOrders, getRevenueChartData, getMonthlyRevenueData, getOrderStatusData };